...
def main():
    ...
    for idx, row in tqdm(df.iterrows(), total=len(df), desc="Processing answers"):
        ...
        df.to_csv("Ouput_Data/KAG_Flan_t5_metrics.csv", index=False)
    ...
    print("\nResults saved to: Ouput_Data/KAG_Flan_t5_metrics.csv")
