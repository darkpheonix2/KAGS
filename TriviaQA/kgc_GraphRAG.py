...
Output:
["Oxford","lost to","Roy Jenkins"]
["Oxford","lost because of","splitting conversative votes with Lord Blake"]
["Heath","severed as","backbencher MP"]
["Health","backbencher MP for","London constituency of Old Bexley and Sidcup"]
["Health","was longest serving","MP"]
["Health","was the oldest","British MP"]
["Health","started in","1992"]
["Health","oversaw","election of two speakers of the common, Betty Boothroyd and Michael Martin."]
["Health","was created a","Kinght of Garter"]
["Health","was Knighted on","23 April 1992"]
["Health","retired from Parliament at","2001 general election"]
["Bexley","was lastly served by men nammed","Health and Tony Benn"]"""
...
{context}"""
    ...
    for idx in tqdm(range(len(df)), desc=f"Extracting with {model_name}"):
        ...
        if (idx + 1) % 10 == 0:
            df.to_csv('GraphRAG_triplets_checkpoint_GraphRAG.csv', index=False, escapechar='\\')
...
if __name__ == "__main__":
    ...
    df.to_csv('Refined_triplets_trivia_GraphRAG.csv', index=False)
