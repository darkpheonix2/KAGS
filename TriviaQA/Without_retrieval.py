...
df["predicted_answer_mistral"] = df["question"].progress_apply(
...
df["predicted_answer_llama"] = df["question"].progress_apply(
    lambda q: answer_generator_single_hop_causal(q, tokenizer, model, DEVICE)
)
...
df["predicted_answer_flan_t5"] = df["question"].progress_apply(
