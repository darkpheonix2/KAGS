...
For example:
Text:
Oxford but lost to Roy Jenkins as a result of splitting the Conservative vote with Lord Blake. Heath continued to serve as a backbencher MP for the London constituency of Old Bexley and Sidcup and was, from 1992, the longest-serving MP ("Father of the House") and the oldest British MP. As Father of the House, he oversaw the election of two Speakers of the Commons, Betty Boothroyd and Michael Martin. Heath was created a Knight of the Garter on 23 April 1992. He retired from Parliament at the 2001 general election. Heath and Tony Benn were the last two serving Bexley (UK Parliament constituency).

Output:
["Oxford","lost to","Roy Jenkins","Oxford but lost to Roy Jenkins as a result of splitting the Conservative vote with Lord Blake."]
["Oxford","lost because of","splitting conversative votes with Lord Blake","Oxford but lost to Roy Jenkins as a result of splitting the Conservative vote with Lord Blake."]
["Heath","severed as","backbencher MP","Heath continued to serve as a backbencher MP for the London constituency of Old Bexley and Sidcup and was, from 1992, the longest-serving MP ("Father of the House") and the oldest British MP."]
["Health","backbencher MP for","London constituency of Old Bexley and Sidcup","Heath continued to serve as a backbencher MP for the London constituency of Old Bexley and Sidcup and was, from 1992, the longest-serving MP ("Father of the House") and the oldest British MP."]
["Health","was longest serving","MP","Heath continued to serve as a backbencher MP for the London constituency of Old Bexley and Sidcup and was, from 1992, the longest-serving MP ("Father of the House") and the oldest British MP."]
["Health","was the oldest","British MP","Heath continued to serve as a backbencher MP for the London constituency of Old Bexley and Sidcup and was, from 1992, the longest-serving MP ("Father of the House") and the oldest British MP."]
["Health","started in","1992","Heath continued to serve as a backbencher MP for the London constituency of Old Bexley and Sidcup and was, from 1992, the longest-serving MP ("Father of the House") and the oldest British MP."]
["Health","oversaw","election of two speakers of the common, Betty Boothroyd and Michael Martin.","As Father of the House, he oversaw the election of two Speakers of the Commons, Betty Boothroyd and Michael Martin."]
["Health","was created a","Kinght of Garter","Heath was created a Knight of the Garter on 23 April 1992."]
["Health","was Knighted on","23 April 1992","Heath was created a Knight of the Garter on 23 April 1992."]
["Health","retired from Parliament at","2001 general election","He retired from Parliament at the 2001 general election."]
["Bexley","was lastly served by men nammed","Health and Tony Benn","Heath and Tony Benn were the last two serving Bexley (UK Parliament constituency)"]"""
...
{context}"""
    ...
    for idx in tqdm(range(len(df)), desc=f"Extracting with {model_name}"):
        ...
        for batch_start in range(0, len(chunks), batch_size):
            ...
            # Batch tokenization
            # Replace batch tokenization block:
            ...
            batch_inputs = batch_encoding["input_ids"].to(model.device)
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('TriviaQA_test.csv')
    ...
    df.to_csv('Refined_triplets_trivia.csv', index=False)
