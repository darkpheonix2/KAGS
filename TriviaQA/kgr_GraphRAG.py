...
from db_config import setup_hf_token, get_weaviate_client
...
WEAVIATE_DB_NAME = "Triplets_GraphRAG"
...
if __name__ == "__main__":
    ...
    # Save results
    result_df.to_csv('GraphRAG_Retrieval_Output.csv', index=False)
    print("Saved to GraphRAG_Retrieval_Output.csv")
