...
df = df[['question', 'combined_positive', 'answers']].sample(frac=1, random_state=42).reset_index(drop=True)
...
df['context_token_count'] = df['combined_positive'].apply(count_context_tokens)
