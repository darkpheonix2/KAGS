...
- The KGC is given in kgc.py
- The embedding and storage is given in kge.py
- The answer generation is given in kga.py
- The evaluation is done using Evaluation.ipynb
