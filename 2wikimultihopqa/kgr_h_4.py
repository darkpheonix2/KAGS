...
triplet_database_name="Triplets_phi4_wiki"
...
def query_pipeline_with_hops(
    ...
    # print('The hits for query ', query_text, ' are : ', hits, '\n')
    ...
    # print('The filtered hits for query ', query_text, ' are : ', filtered, '\n')
    ...
    # print('The graph context for query ', query_text, ' are : ', graph_context, '\n')
...
if __name__ == "__main__":
    ...
    result_df = process_dataframe_with_retrieval(
        ...
        top_k=7,
        meta_sim_threshold=0.8,
        h_hops=2,
        max_nodes_per_hop=10,
        dedup_method="hybrid",  # Options: "exact", "semantic", "hybrid", "clustering"
        verbose=True
    )
    result_df.to_csv('AblationStudy/KAG_test_with_retrieval_t_as_08.csv', index=False)
